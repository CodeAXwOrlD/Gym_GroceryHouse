...
export default function Page(_a) {
    ...
    var _c = useState(undefined), catData = _c[0], setCatData = _c[1];
    useEffect(function () {
    ...
    var _d = useSWR('/gettingAllCategoriesFOrAdmin', function () { return get_category_by_id(params.id); }), data = _d.data, isLoading = _d.isLoading;
    ...
    var setValueofFormData = useCallback(function () {
        var _a, _b, _c;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, update_a_category(updatedData)];
                case 1:
                    res = _a.sent();
            ...
            {isLoading || loader ? (<div className='w-full  flex-col h-96 flex items-center justify-center '>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg  py-2 flex-col ">
                            ...
                            {catData && (<div className="form-control">
                                        ...
                                        <Image src={(catData === null || catData === void 0 ? void 0 : catData.categoryImage) || ""} alt='No Image Found' width={200} height={200}/>
