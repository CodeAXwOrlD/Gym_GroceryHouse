...
var OrdersDetailsDataTable_1 = __importDefault(require("@/components/OrdersDetailsDataTable"));
...
function Page() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, order_1.get_all_orders_of_user)(user === null || user === void 0 ? void 0 : user._id)];
                case 1:
                    orderData = _a.sent();
                    if (orderData === null || orderData === void 0 ? void 0 : orderData.success) {
                        dispatch((0, OrderSlice_1.setOrder)(orderData === null || orderData === void 0 ? void 0 : orderData.data));
                    }
                    else {
    ...
    return (<div className='w-full bg-gray-50 h-screen px-2 py-2'>
      ...
      <div className='w-full h-5/6 py-2'>
        <OrdersDetailsDataTable_1.default />
      </div>
