...
var AddToCart = joi_1.default.object({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    error = AddToCart.validate({ productID: productID, userID: userID }).error;
                    if (error)
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: error.details[0].message.replace(/['"]+/g, '') })];
                    return [4 /*yield*/, Cart_1.default.find({ productID: productID, userID: userID })];
                case 4:
                    findProd = _a.sent();
                    if ((findProd === null || findProd === void 0 ? void 0 : findProd.length) > 0)
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: "Product is Already in Cart" })];
                    return [4 /*yield*/, Cart_1.default.create(data)];
                case 5:
                    saveData = _a.sent();
                    if (saveData) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: true, message: "Product added to Cart!" })];
                    }
                    else {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: "Failed to add product to cart. Please try again!" })];
                    }
                    return [3 /*break*/, 7];
                ...
                case 8:
                    error_1 = _a.sent();
                    console.log('Error in adding a product to cart :', error_1);
