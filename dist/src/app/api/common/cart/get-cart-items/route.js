        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, Cart.find({ userID: id }).populate('userID').populate('productID')];
                case 6:
                    getData = _a.sent();
                    if (getData) {
                        ...
                        return [2 /*return*/, NextResponse.json({ status: 204, success: false, message: 'No Cart Item found.' })];
                    }
                    return [3 /*break*/, 8];
