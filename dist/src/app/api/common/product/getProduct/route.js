...
function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var registerCategoryModel, getData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Product_1.default.find({}).populate('productCategory', ' categoryName categorySlug _id')];
                case 4:
                    getData = _a.sent();
                    if (getData) {
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ status: 204, success: false, message: 'No products found.' })];
                    }
                    return [3 /*break*/, 6];
                case 5:
                    error_1 = _a.sent();
                    console.log('Error in getting all products:', error_1);
