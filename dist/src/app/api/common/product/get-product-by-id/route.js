        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!id)
                        return [2 /*return*/, NextResponse.json({ status: 400, success: false, message: 'Please provide Product id.' })];
                    return [4 /*yield*/, Category.init()];
                case 3:
                    registerCategoryModel = _a.sent();
                    return [4 /*yield*/, Product.findById(id).populate('productCategory', ' categoryName categorySlug _id')];
                case 4:
                    getData = _a.sent();
                    if (getData) {
