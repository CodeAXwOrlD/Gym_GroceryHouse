...
function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, id, isAuthenticated, getData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!id)
                        return [2 /*return*/, server_1.NextResponse.json({ status: 400, success: false, message: 'Please Login !' })];
                    return [4 /*yield*/, (0, AuthCheck_1.default)(req)];
                case 3:
                    isAuthenticated = _a.sent();
                    if (!isAuthenticated) return [3 /*break*/, 5];
                    return [4 /*yield*/, Order_1.default.findById(id).populate("orderItems.product").populate('user')];
                case 4:
                    getData = _a.sent();
                    if (getData) {
                        console.log(getData);
                        ...
                        return [2 /*return*/, server_1.NextResponse.json({ status: 204, success: false, message: 'No Order Found .' })];
                    }
                    return [3 /*break*/, 6];
                case 5: return [2 /*return*/, server_1.NextResponse.json({ success: false, message: "You are not authorized Please login!" })];
                case 6: return [3 /*break*/, 8];
                case 7:
                    error_1 = _a.sent();
                    console.log('Error in getting  Orders details Data :', error_1);
