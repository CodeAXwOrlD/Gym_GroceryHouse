...
function GET(req) {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, id, registerProductModel, registerUserModel, isAuthenticated, getData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, Order_1.default.find({ user: id }).populate("orderItems.product").populate('user')];
                case 6:
                    getData = _a.sent();
                    if (getData) {
                ...
                case 9:
                    error_1 = _a.sent();
                    console.log('Error in getting  Orders Data :', error_1);
