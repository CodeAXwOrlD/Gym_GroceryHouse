        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Product.findOneAndUpdate(_id, { productName: name_1, productDescription: description, productSlug: slug, productPrice: price, productQuantity: quantity, productCategory: categoryID }, { new: true })];
                case 4:
                    saveData = _a.sent();
                    if (saveData) {
                        return [2 /*return*/, NextResponse.json({ success: true, message: "product  updated successfully!" })];
                    }
                    else {
                        return [2 /*return*/, NextResponse.json({ success: false, message: "Failed to update the product . Please try again!" })];
                    }
                    return [3 /*break*/, 6];
