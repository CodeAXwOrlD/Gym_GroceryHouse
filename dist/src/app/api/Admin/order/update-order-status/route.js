...
function PUT(req) {
    return __awaiter(this, void 0, void 0, function () {
        var isAuthenticated, data, id, saveData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    console.log(id);
                    if (!id)
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: "Please provide the order id!" })];
                    return [4 /*yield*/, Order_1.default.findOneAndUpdate(id, { isDelivered: true }, { new: true })];
                case 4:
                    saveData = _a.sent();
                    if (saveData) {
                        return [2 /*return*/, server_1.NextResponse.json({ success: true, message: "Order status updated successfully!" })];
                    }
                    else {
                        return [2 /*return*/, server_1.NextResponse.json({ success: false, message: "Failed to update the Order status. Please try again!" })];
                    }
                    return [3 /*break*/, 6];
                ...
                case 7:
                    error_1 = _a.sent();
                    console.log('Error in update order status:', error_1);
