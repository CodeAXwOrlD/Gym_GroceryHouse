...
function ForgetPassword() {
    ...
    var _a = (0, react_1.useState)({ email: "", password: "", confirmPassword: "" }), formData = _a[0], setFormData = _a[1];
    var _b = (0, react_1.useState)({ email: "", password: "", confirmPassword: "" }), error = _b[0], setError = _b[1];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!formData.confirmPassword) {
                        setError(__assign(__assign({}, error), { confirmPassword: "Confirm Password Field is required" }));
                        return [2 /*return*/];
                    }
                    if (formData.password !== formData.confirmPassword) {
                        react_toastify_1.toast.error("Password and Confirm Password does not match");
                    }
                    return [4 /*yield*/, (0, auth_1.forget_password)(formData)];
                case 1:
                    res = _a.sent();
                    if (res.success) {
                        setLoding(false);
          ...
          <div className="w-full p-6 bg-white rounded-lg shadow  md:mt-0 sm:max-w-md  sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4 lg:mt-5 md:space-y-5">
              ...
              <div className='text-left'>
                ...
                <input onChange={function (e) { return setFormData(__assign(__assign({}, formData), { confirmPassword: e.target.value })); }} type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-orange-600 focus:border-orange-600 block w-full p-2.5 "/>
