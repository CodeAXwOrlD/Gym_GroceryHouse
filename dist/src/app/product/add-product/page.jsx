        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    finalData = { productName: data.name, productDescription: data.description, productImage: uploadImageToFirebase, productSlug: data.slug, productFeatured: data.feature, productPrice: data.price, productQuantity: data.quantity, productCategory: data.categoryID };
                    return [4 /*yield*/, (0, product_1.add_new_product)(finalData)];
                case 2:
                    res = _a.sent();
                    if (res.success) {
