            ...
            <div className="flex-1">
                <div className="dropdown md:hidden">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow text-black bg-gray-50 rounded-box w-52">
                        <li onClick={function () { return dispatch(setNavActive('Base')); }}><button>Homepage</button></li>
                        <li onClick={function () { return dispatch(setNavActive('activeCategories')); }}><button>Categories</button></li>
                        <li onClick={function () { return dispatch(setNavActive('activeProducts')); }}><button>Products</button></li>
                        <li><Link href={"/product/add-product"}>Add Products</Link></li>
                        <li><Link href={"/category/add-category"}>Add Category</Link></li>
                        <li onClick={function () { return dispatch(setNavActive('activePendingOrder')); }}><button>Pending orders</button></li>
                        <li onClick={function () { return dispatch(setNavActive('activeDeliveredOrder')); }}><button>Completed orders</button></li>
                    </ul>
                </div>
            </div>
