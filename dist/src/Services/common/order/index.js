...
var create_a_new_order = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/common/order/create-order", {
                        method: 'POST',
                        headers: {
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Error in creating Order (service) =>', error_1);
                return [3 /*break*/, 4];
...
var get_all_orders_of_user = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_2 = _a.sent();
                console.log('Error in getting all orders Item for specific User (service) =>', error_2);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var get_order_details = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_3 = _a.sent();
                console.log('Error in getting all orders Item for specific User (service) =>', error_3);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
