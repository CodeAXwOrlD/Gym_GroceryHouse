...
var get_all_orders = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('/api/Admin/order/get-all-order-data', {
                        method: 'GET',
                        headers: {
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Error in getting all orders (service) =>', error_1);
                return [3 /*break*/, 4];
...
var update_order_status = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                error_2 = _a.sent();
                console.log('Error in updating order status (service) =>', error_2);
                return [3 /*break*/, 5];
