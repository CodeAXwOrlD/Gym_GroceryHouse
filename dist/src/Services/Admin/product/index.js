...
var add_new_product = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/Admin/product/add-product", {
                        method: 'POST',
                        headers: {
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Error in Add New Category (service) =>', error_1);
                return [3 /*break*/, 4];
...
var get_all_products = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('/api/common/product/getProduct', {
                        method: 'GET',
                    })];
            case 1:
                res = _a.sent();
            ...
            case 3:
                error_2 = _a.sent();
                console.log('Error in getting all products (service) =>', error_2);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var delete_a_product = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_3 = _a.sent();
                console.log('Error in deleting Product (service) =>', error_3);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var update_a_product = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_4 = _a.sent();
                console.log('Error in updating Product (service) =>', error_4);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var get_product_by_id = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/common/product/get-product-by-id?id=".concat(id), {
                        method: 'GET',
                    })];
            case 1:
                res = _a.sent();
            ...
            case 3:
                error_5 = _a.sent();
                console.log('Error in getting product by ID (service) =>', error_5);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var get_product_by_category_id = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/common/product/get-product-by-category-id?id=".concat(id), {
                        method: 'GET',
                    })];
            case 1:
                res = _a.sent();
            ...
            case 3:
                error_6 = _a.sent();
                console.log('Error in getting product by category ID (service) =>', error_6);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
