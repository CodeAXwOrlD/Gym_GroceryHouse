...
var get_all_categories = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch('/api/common/category/getCategory', {
                        method: 'GET',
                    })];
            case 1:
                res = _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.log('Error in getting all Categories (service) =>', error_1);
                return [3 /*break*/, 4];
...
var add_new_category = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/Admin/category/add-category", {
                        method: 'POST',
                        headers: {
            ...
            case 3:
                error_2 = _a.sent();
                console.log('Error in Add New Category (service) =>', error_2);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var get_category_by_id = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("/api/common/category/get-category-by-id?id=".concat(id), {
                        method: 'GET',
                    })];
            case 1:
                res = _a.sent();
            ...
            case 3:
                error_3 = _a.sent();
                console.log('Error in getting Categories by ID (service) =>', error_3);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var delete_a_category = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_4 = _a.sent();
                console.log('Error in deleting Categories (service) =>', error_4);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var update_a_category = function (formData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_5 = _a.sent();
                console.log('Error in updating Categories (service) =>', error_5);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
